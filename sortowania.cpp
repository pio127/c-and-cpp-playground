...
int main(){
	...
	// Komparator działa tak, że jeżeli zwraca true, to elementy nie są zamieniane.
	// Jeżeli false to je zamienia, dlatego domyslnie jest x<y, gdzie x jest pierwszym elementem
	// odwrócenie warunku da tablicę posortowaną malejąco.
