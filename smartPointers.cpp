...
class Test
{
	...
	public:
		...
		~Test(){
			cout<<"	Obiekt typu Test o adresie: " <<this<<" usuniety\n";
		}
};
...
int main(){
	...
	(std::max(p1.get(), p2.get())-std::min(p1.get(), p2.get()))*sizeof(Test)<<" bajtow\n"; 
	...
	cout<<"\nSHARED\n";
	// Bardziej wydajne jest przez std::make_shared inicjalizować
	...
	cout<<"\nWEAK\n";
	// Uzywane przy wskazaniach cyklicznych: obiekt A posiada wskaznik na B i vice versa
	...
	std::shared_ptr<Test> p8{new Test{"p8"}, 
		[](Test *ptr){
